#!/usr/bin/env python3
"""
Deploy only core AquaChain stacks (minimal deployment)
Skips optional stacks that have compatibility issues
"""
...
def main():
    ...
    print(f"Deploying core stacks for environment: {env_name}")
    ...
    print("Core stacks configured successfully")
    print("Stacks to be deployed:")
    print(f"  1. AquaChain-Security-{env_name}")
    print(f"  2. AquaChain-Core-{env_name}")
    print(f"  3. AquaChain-Data-{env_name}")
    print(f"  4. AquaChain-Compute-{env_name}")
    print(f"  5. AquaChain-API-{env_name}")
    print(f"  6. AquaChain-Monitoring-{env_name}")
