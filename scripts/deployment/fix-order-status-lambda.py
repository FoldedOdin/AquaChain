#!/usr/bin/env python3
"""
Fix the order status update Lambda function deployment
"""
import boto3
import zipfile
import os
...
def update_lambda_function():
    """Update the Lambda function with correct code and configuration"""
        ...
        lambda_client.update_function_configuration(
            ...
            Environment={
                'Variables': {
                    ...
                    'TECHNICIANS_TABLE': 'aquachain-table-technicians-dev'
                }
            }
        )
...
if __name__ == "__main__":
    print("🚀 Fixing order status update Lambda function...")
