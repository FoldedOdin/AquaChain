# Update Data Processing Lambda to use HTTP API handler
...
Write-Host "Update Data Processing Lambda Handler" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

# Step 1: Package the Lambda function
Write-Host "[1/4] Packaging Lambda function..." -ForegroundColor Yellow
Push-Location lambda/data_processing
...
Write-Host "   GET /dashboard/stats" -ForegroundColor Gray
Write-Host "   GET /water-quality/latest" -ForegroundColor Gray
Write-Host "2. Check CloudWatch logs for any errors" -ForegroundColor White
Write-Host "3. Proceed to Phase 1, Step 3: Alert Detection Handler" -ForegroundColor White
Write-Host ""
